            ...
            <div class="margin text-center">
              <div class="s-12 m-12 l-4 margin-bottom">
                <div class="padding-2x block-bordered border-radius">
                  ...
                  <h2 class="text-thin">Siswa</h2>
                  <p class="margin-bottom-30">Berisi nama dan status daftar</p>
              ...
              <div class="s-12 m-12 l-4 margin-bottom">
                <div class="padding-2x block-bordered border-radius">
                  ...
                  <h2 class="text-thin">Online</h2>
                  <p class="margin-bottom-30">Berisi siswa yang sedang online</p>
                  <a class="button border-radius background-primary text-size-12 text-white text-strong" href="#">GET MORE INFO</a>
                </div>
              </div>
              <div class="s-12 m-12 l-4 margin-bottom">
