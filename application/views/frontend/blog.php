   <section class="title">
            ...
            <div class="span8">
                <div class="blog">
                    <div class="blog-item well">
                      ...
                      <p><img src="<?php echo base_url(). 'frontend/template/images/sample/blog1.jpg';?>"  width="100%" alt="" /></p>
    ...
    <aside class="span4">
        ...
        <div class="widget ads">
            <div class="row-fluid">
                <div class="span6">
                    <a href="#"><img src="<?php echo base_url(). 'frontend/template/images/ads/ad1.png';?>" alt=""></a>
                </div>

                <div class="span6">
                    <a href="#"><img src="<?php echo base_url(). 'frontend/template/images/ads/ad2.png';?>" alt=""></a>
                </div>
            </div>
            <p> </p>
            <div class="row-fluid">
                <div class="span6">
                    <a href="#"><img src="<?php echo base_url(). 'frontend/template/images/ads/ad3.png';?>" alt=""></a>
                </div>

                <div class="span6">
                    <a href="#"><img src="<?php echo base_url(). 'frontend/template/images/ads/ad4.png';?>" alt=""></a>
                </div>
            </div>
        </div>
        <!-- /.ads -->
