    ...
    <section id="about-us" class="container main">
        ...
        <div class="row-fluid">
            <div class="span3">
                <div class="box">
                    <p><img src="<?php echo base_url(). 'frontend/template/images/sample/team1.jpg" alt="';?>" ></p>
            ...
            <div class="span3">
                <div class="box">
                    <p><img src="<?php echo base_url(). 'frontend/template/images/sample/team2.jpg" alt="';?>" ></p>
            ...
            <div class="span3">
                <div class="box">
                    <p><img src="<?php echo base_url(). 'frontend/template/images/sample/team4.jpg" alt="';?>" ></p>
            ...
            <div class="span3">
                <div class="box">
                    <p><img src="<?php echo base_url(). 'frontend/template/images/sample/team3.jpg" alt="';?>" ></p>
