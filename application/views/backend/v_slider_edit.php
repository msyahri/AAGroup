...
<section class="content">
  ...
  <div class="row">
    ...
    <form action="<?php echo base_url(). 'administrator/slider/edit_aksi'; ?> " method="post" id="form-satuan" enctype="multipart/form-data">
      ...
      <tr>
      <td></td>
      <td><img src="<?php echo base_url(). 'frontend/template/images/uploads/'?><?php echo $s->foto_slider?>" alt="" width="300"></td>
      </tr>
      ...
      <tr>
            ...
            <tr>
                <td></td>
                <td><input type="submit" class="btn btn-success" value="Edit"> <input type="reset" class="btn btn-warning" value="Edit">
